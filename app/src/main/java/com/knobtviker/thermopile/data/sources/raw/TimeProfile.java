 ...
 */
public class TimeProfile extends AbstractProfile {
    ...
    /**
     * Return a configured {@link BluetoothGattService} instance for the Current Time Service.
     */
    @Override
    public BluetoothGattService createService() {
        ...
        final BluetoothGattCharacteristic currentTime = new BluetoothGattCharacteristic(
            CURRENT_TIME,
        ...
        final BluetoothGattCharacteristic localTime = new BluetoothGattCharacteristic(
            LOCAL_TIME_INFO,
        ...
        final BluetoothGattDescriptor configDescriptor = new BluetoothGattDescriptor(
            CLIENT_CONFIG,
