...
public class MagneticField extends CartesianModel {
    ...
    public MagneticField(final long timestamp, @NonNull final String vendor, @NonNull final String name, final float valueX, final float valueY, final float valueZ) {
