...
public class AirQuality extends RealmObject implements SingleValue {

    public AirQuality(final long timestamp, final float value, final int accuracy, @NonNull final String vendor, @NonNull final String name) {
        timestamp(timestamp);
        value(value);
        accuracy(accuracy);
        vendor(vendor);
