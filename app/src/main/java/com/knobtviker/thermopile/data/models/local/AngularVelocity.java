...
public class AngularVelocity extends CartesianModel {
    ...
    public AngularVelocity(final long timestamp, @NonNull final String vendor, @NonNull final String name, final float valueX, final float valueY, final float valueZ) {
