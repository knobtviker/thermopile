package com.knobtviker.thermopile.data.sources.raw.lsm9ds1;
...
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelGyroOutputDataRate.ODR_119HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelGyroOutputDataRate.ODR_14_9HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelGyroOutputDataRate.ODR_238HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelGyroOutputDataRate.ODR_476HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelGyroOutputDataRate.ODR_59_5HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelGyroOutputDataRate.ODR_952HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelGyroOutputDataRate.ODR_POWER_DOWN;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelerometerDecimation.ACCEL_DEC_0_SAMPLES;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelerometerDecimation.ACCEL_DEC_2_SAMPLES;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelerometerDecimation.ACCEL_DEC_4_SAMPLES;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelerometerDecimation.ACCEL_DEC_8_SAMPLES;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelerometerRange.ACCEL_RANGE_16G;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelerometerRange.ACCEL_RANGE_2G;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelerometerRange.ACCEL_RANGE_4G;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.AccelerometerRange.ACCEL_RANGE_8G;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.FifoMode.FIFO_CONT;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.FifoMode.FIFO_CONT_TRIGGER;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.FifoMode.FIFO_OFF;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.FifoMode.FIFO_OFF_TRIGGER;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.FifoMode.FIFO_THS;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.GyroscopeScale.GYRO_SCALE_2000DPS;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.GyroscopeScale.GYRO_SCALE_245DPS;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.GyroscopeScale.GYRO_SCALE_500DPS;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagOutputDataRate.ODR_M_0_625HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagOutputDataRate.ODR_M_10HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagOutputDataRate.ODR_M_1_25HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagOutputDataRate.ODR_M_20HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagOutputDataRate.ODR_M_2_5HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagOutputDataRate.ODR_M_40HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagOutputDataRate.ODR_M_6HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagOutputDataRate.ODR_M_80HZ;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerGain.MAG_GAIN_12GAUSS;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerGain.MAG_GAIN_16GAUSS;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerGain.MAG_GAIN_4GAUSS;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerGain.MAG_GAIN_8GAUSS;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerSystemOperatingMode.MAG_CONTINUOUS_CONVERSION;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerSystemOperatingMode.MAG_POWER_DOWN;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerSystemOperatingMode.MAG_SINGLE_CONVERSION;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerXYOperatingMode.MAG_XY_OM_HIGH_PERFORMANCE;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerXYOperatingMode.MAG_XY_OM_LOW_POWER;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerXYOperatingMode.MAG_XY_OM_MEDIUM_PERFORMANCE;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerXYOperatingMode.MAG_XY_OM_ULTRA_HIGH_PERFORMANCE;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerZOperatingMode.MAG_Z_OM_HIGH_PERFORMANCE;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerZOperatingMode.MAG_Z_OM_LOW_POWER;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerZOperatingMode.MAG_Z_OM_MEDIUM_PERFORMANCE;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.MagnetometerZOperatingMode.MAG_Z_OM_ULTRA_HIGH_PERFORMANCE;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.SensorType.SENSOR_MAG;
import static com.knobtviker.thermopile.data.sources.raw.lsm9ds1.Lsm9ds1.SensorType.SENSOR_XG;
...
public class Lsm9ds1 implements Closeable {
    ...
    @IntDef({ACCEL_RANGE_2G, ACCEL_RANGE_4G, ACCEL_RANGE_8G, ACCEL_RANGE_16G})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({ACCEL_DEC_0_SAMPLES, ACCEL_DEC_2_SAMPLES, ACCEL_DEC_4_SAMPLES, ACCEL_DEC_8_SAMPLES})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({GYRO_SCALE_245DPS, GYRO_SCALE_500DPS, GYRO_SCALE_2000DPS})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({ODR_POWER_DOWN, ODR_14_9HZ, ODR_59_5HZ, ODR_119HZ, ODR_238HZ, ODR_476HZ, ODR_952HZ})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({MAG_GAIN_4GAUSS, MAG_GAIN_8GAUSS, MAG_GAIN_12GAUSS, MAG_GAIN_16GAUSS})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({MAG_CONTINUOUS_CONVERSION, MAG_SINGLE_CONVERSION, MAG_POWER_DOWN})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({MAG_XY_OM_LOW_POWER, MAG_XY_OM_MEDIUM_PERFORMANCE, MAG_XY_OM_HIGH_PERFORMANCE, MAG_XY_OM_ULTRA_HIGH_PERFORMANCE})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({MAG_Z_OM_LOW_POWER, MAG_Z_OM_MEDIUM_PERFORMANCE, MAG_Z_OM_HIGH_PERFORMANCE, MAG_Z_OM_ULTRA_HIGH_PERFORMANCE})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({ODR_M_0_625HZ, ODR_M_1_25HZ, ODR_M_2_5HZ, ODR_M_6HZ, ODR_M_10HZ, ODR_M_20HZ, ODR_M_40HZ, ODR_M_80HZ})
     ...
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({FIFO_OFF, FIFO_THS, FIFO_CONT_TRIGGER, FIFO_OFF_TRIGGER, FIFO_CONT})
    ...
    public static class Builder {
        ...
        @FifoMode
        private int mFifoMode = FIFO_OFF;
        @FifoThreshold
